    ...
    return BlocConsumer<ScheduleCubit, ScheduleState>(
      listener: (context, state) {
        if (state is ScheduleSuccessState) {
          ...
          SnackBar snackBar =
          SnackBarComponent.snackBar(content: 'Make schedule has a problem');
          ...
          floatingActionButton: Padding(
            ...
            child: AppButton.normalButton(
              ...
              onPress: () {
                ...
                cubit.makeSchedule(
                  period: breakTimeController.text,
                  work_from: formatTime(lunchFromTimeController.text),
                  work_to: formatTime(lunchToTimeController.text),
                  break_from: formatTime(drinkFromTimeController.text),
                  break_to: formatTime(drinkToTimeController.text),
                );
              },
            ),
          ),
