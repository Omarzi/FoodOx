...
class FromHomeToLunchScreen extends StatefulWidget {
  FromHomeToLunchScreen({Key? key}) : super(key: key);

  @override
  State<FromHomeToLunchScreen> createState() =>
      _FromHomeToLunchScreenState();
}

class _FromHomeToLunchScreenState extends State<FromHomeToLunchScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CategoriesCubit, CategoriesState>(
      ...
      builder: (context, state) {
        ...
        var lunchModel = cubit.getLunchModel;
        return Scaffold(
              ...
              Padding(
                ...
                child: NotificationListener<
                  ...
                  child: GridView.builder(
                    shrinkWrap: true,
                    itemCount: lunchModel.food!.length,
                    gridDelegate:
                        ...
                        child: Column(
                          children: [
                            ...
                            ClipRRect(
                              borderRadius: BorderRadius.circular(20.r),
                              child: Image.network(
                                '${AppConstants.baseUrl}${lunchModel.food![index].img.toString()}',
                                height: 90.h,
                                width: 164.w,
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${lunchModel.food![index].price} EGP',
                                    style:
                                    GoogleFonts.darkerGrotesque(
                                      height: 1.h,
                                      color: AppColors.whiteColor,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  choossenList.contains(lunchModel
                                      .food![index]) ==
                                      true
                                      ? Icon(
                                    Icons.check_circle,
                                  ...
                                  Text(
                                    '${lunchModel.food![index].category}',
                                    style:
                                    GoogleFonts.darkerGrotesque(
                                      height: 1.h,
                                      color: AppColors.whiteColor,
